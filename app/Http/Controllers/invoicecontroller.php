...
class invoicecontroller extends Controller
{
    ...
    ->addColumn('edit', function($row){
     if($row->p_wating==1)
     {
    $btn ='<tr><td><a   href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$row->id.'" data-original-title="Edit" class="edit btn btn-info btn-sm accept">تاكيد</a></td><tr>';
    ...
    ->addColumn('new', function($row){
        $btn = '<tr><td> <a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$row->id.'" data-original-title="Delete" class="btn btn-secondary btn-sm  editBook">تاكيد</a></td></tr>';
